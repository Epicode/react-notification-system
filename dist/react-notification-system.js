...
/***/ (function(module, exports, __webpack_require__) {
	...
	var NotificationSystem = createReactClass({
	  ...
	  _renderDefault: function () {
	    function _renderDefault(containers) {
	      return React.createElement(
	        'div',
	        { className: 'notifications-wrapper ' + this.props.systemClassName, style: this._getStyles.wrapper() },
	        containers
	      );
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var NotificationContainer = createReactClass({
	  ...
	  _renderDefault: function () {
	    function _renderDefault(notifications) {
	      return React.createElement(
	        'div',
	        { className: 'notifications-' + this.props.position + ' ' + this.props.containerClassName, style: this._style },
	        notifications
	      );
	    }
	...
	var NotificationItem = createReactClass({
	  ...
	  _renderDefault: function () {
	    function _renderDefault() {
	      ...
	      return React.createElement(
	        'div',
	        { className: className + ' ' + this.props.itemClassName, onClick: this._handleNotificationClick, onMouseEnter: this._handleMouseEnter, onMouseLeave: this._handleMouseLeave, style: notificationStyle },
	        title,
	        message,
	        dismiss,
	        actionButton
